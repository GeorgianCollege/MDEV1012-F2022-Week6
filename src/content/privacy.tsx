...
function Privacy()
{
    return(
        <div>
            ...
            <p>Our Privacy Policy was last updated on November 30, 2022.</p>
            ...
            <li>
            <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named TV Shows List App</p>
            </li>
            <li>
            <p><strong>"Company"</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Tom Tsiliopoulos</p>
            </li>
            <li>
            ...
            <ul>
            <li>By visiting the <Link to ={"/contact"}>Contact Page</Link> on our website</li>
            </ul>
            <p>&nbsp;</p>
        </div>
    )
